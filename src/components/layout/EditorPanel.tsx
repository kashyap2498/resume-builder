        ...
        {sorted.map((section) => {
          ...
          return (
            <div
              ...
              className={cn(
                'group rounded-xl border bg-white dark:bg-dark-card p-6 transition-all duration-200',
                isActive
                  ? 'border-gray-200 dark:border-dark-edge-strong shadow-[var(--shadow-glass-md)]'
                  : 'border-gray-200 dark:border-dark-edge shadow-[var(--shadow-glass-sm)] hover:border-gray-300/80 hover:shadow-[var(--shadow-glass-md)]',
              )}
            >
              {/* Section header */}
              <div
                ...
                <div
                  className={cn(
                    ...
                    isActive
                      ...
                      : 'bg-gray-100/80 dark:bg-dark-raised text-gray-500 group-hover:bg-gray-100 dark:group-hover:bg-dark-raised',
                  )}
                >
              ...
              <AnimatePresence initial={false}>
                {isActive ? (
                  ...
                  >
                    <div
                      className="rounded-lg border border-dashed border-gray-200 dark:border-dark-edge bg-gray-50/50 dark:bg-dark-raised px-4 py-3 cursor-pointer"
                      onClick={() => toggleSection(section.id)}
                    >
                      <p className={cn(
                        'text-xs truncate',
                        summary ? 'text-gray-500 dark:text-gray-400' : 'text-center text-gray-500 dark:text-gray-400 italic'
                      )}>
