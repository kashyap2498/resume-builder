...
const badges = [
  { icon: ShieldCheck, text: 'No Subscription Required', accent: 'text-emerald-600' },
  { icon: CreditCard, text: 'One-Time Payment', accent: 'text-blue-600' },
  { icon: RefreshCcw, text: '7-Day Money Back', accent: 'text-amber-600' },
  { icon: FileCheck, text: '18+ ATS Templates', accent: 'text-purple-600' },
] as const;
          ...
          {badges.map((badge, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-2 px-2">
                <badge.icon className={`h-4 w-4 ${badge.accent}`} />
