// =============================================================================
// Whitespace - Preview Template (HTML/CSS)
// =============================================================================
...
const WhitespacePreview: React.FC<TemplateProps> = ({ resume }) => {
  const { data, styling, sections } = resume;
  const { font, colors, layout } = styling;

  // Generous spacing multiplier
  ...
  const renderSection = (section: SectionConfig) => {
    switch (section.type) {
      case 'contact':
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px`, textAlign: 'center' }}>
            <h1
              style={{
      ...
      case 'summary':
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
            ...
            {data.certifications.map((entry) => (
              <EntryBlock key={entry.id} title={entry.name} subtitle={entry.issuer} dateRange={entry.date} description={entry.credentialId ? `Credential ID: ${entry.credentialId}` : undefined} font={font} colors={colors} spacing={layout.itemSpacing + 4} />
            ))}
          </div>
        );
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
            ...
            {data.volunteer.map((entry) => (
              <EntryBlock key={entry.id} title={entry.role} subtitle={entry.organization} dateRange={formatDateRange(entry.startDate, entry.endDate)} description={entry.description} highlights={entry.highlights} font={font} colors={colors} spacing={layout.itemSpacing + 4} />
            ))}
          </div>
        );
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
            ...
            {data.awards.map((entry) => (
              <EntryBlock key={entry.id} title={entry.title} subtitle={entry.issuer} dateRange={entry.date} description={entry.description} font={font} colors={colors} spacing={layout.itemSpacing + 4} />
            ))}
          </div>
        );
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
            ...
            {data.publications.map((entry) => (
              <EntryBlock key={entry.id} title={entry.title} subtitle={entry.publisher} dateRange={entry.date} description={entry.description} font={font} colors={colors} spacing={layout.itemSpacing + 4} />
            ))}
          </div>
        );
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
            ...
            {data.references.map((entry) => (
              <div key={entry.id} style={{ marginBottom: `${layout.itemSpacing + 4}px` }}>
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
            ...
            {data.affiliations.map((entry) => (
              <EntryBlock key={entry.id} title={entry.organization} subtitle={entry.role} dateRange={formatDateRange(entry.startDate, entry.endDate)} font={font} colors={colors} spacing={layout.itemSpacing + 4} />
            ))}
          </div>
        );
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${sectionGap}px` }}>
            ...
            {data.courses.map((entry) => (
              <EntryBlock key={entry.id} title={entry.name} subtitle={entry.institution} dateRange={entry.completionDate} description={entry.description} font={font} colors={colors} spacing={layout.itemSpacing + 4} />
            ))}
          </div>
        );
        ...
        return (
          <React.Fragment key={section.id}>
            {data.customSections.map((cs) => (
              <div key={cs.id} style={{ marginBottom: `${sectionGap}px` }}>
                <h2 style={sectionTitleStyle}>{cs.title}</h2>
                {cs.entries.map((entry) => (
                  <EntryBlock key={entry.id} title={entry.title} subtitle={entry.subtitle} dateRange={entry.date} description={entry.description} highlights={entry.highlights} font={font} colors={colors} spacing={layout.itemSpacing + 4} />
                ))}
              </div>
            ))}
          </React.Fragment>
  ...
  return (
    <div
      style={{
        ...
        maxWidth: '816px',
        margin: '0 auto',
        padding: `${layout.margins.top + 8}px ${layout.margins.right + 8}px ${layout.margins.bottom + 8}px ${layout.margins.left + 8}px`,
...
export default WhitespacePreview;
