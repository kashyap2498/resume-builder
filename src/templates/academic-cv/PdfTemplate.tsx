// =============================================================================
// Academic CV - PDF Template (@react-pdf/renderer)
// =============================================================================
  ...
  const renderSection = (section: SectionConfig) => {
    switch (section.type) {
      ...
      case 'summary':
        ...
        return (<View key={section.id} style={styles.sectionContainer}><Text style={styles.sectionTitle}>Research Statement</Text><Text style={styles.descriptionItalic}>{data.summary.text}</Text></View>);
      case 'education':
