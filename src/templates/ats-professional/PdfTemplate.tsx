// =============================================================================
// ATS Professional - PDF Template (@react-pdf/renderer)
// =============================================================================
    ...
    switch (section.type) {
      ...
      case 'skills':
        ...
        return (
          <View key={section.id} style={styles.sectionContainer}>
            <Text style={styles.sectionTitle}>{section.title}</Text>
            <SkillsBlockPdf skills={data.skills} layout={data.skillsLayout} mode={data.skillsMode} fontSize={font.sizes.normal} fontFamily={bodyFont} textColor={colors.text} categoryColor={headingColor} categoryFontFamily={bodyFont} />
          </View>
        );
...
export default AtsProfessionalPdf;
