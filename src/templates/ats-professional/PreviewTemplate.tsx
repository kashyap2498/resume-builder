...
import { SectionHeading, EntryBlock, ContactLine, SkillsBlock, CustomContentBlock } from '../shared';
    ...
    switch (section.type) {
      ...
      case 'skills':
        ...
        return (
          <div key={section.id} style={{ marginBottom: `${layout.sectionSpacing}px` }}>
            <SectionHeading title={section.title} font={font} colors={{ ...colors, primary: headingColor }} variant="uppercase" showDivider dividerStyle="line" />
            <SkillsBlock skills={data.skills} layout={data.skillsLayout} mode={data.skillsMode} font={font} colors={colors} categoryColor={headingColor} />
          </div>
        );
