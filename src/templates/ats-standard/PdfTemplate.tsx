// =============================================================================
// ATS Standard - PDF Template (@react-pdf/renderer)
// =============================================================================
...
const AtsStandardPdf: React.FC<TemplateProps> = ({ resume }) => {
    ...
    switch (section.type) {
      ...
      case 'skills':
        ...
        return (
          <View key={section.id} style={styles.sectionContainer}>
            <Text style={styles.sectionTitle}>{section.title}</Text>
            <SkillsBlockPdf skills={data.skills} layout={data.skillsLayout} mode={data.skillsMode} fontSize={font.sizes.normal} fontFamily={bodyFont} textColor={colors.text} categoryColor={colors.text} categoryFontFamily={bodyFont} />
          </View>
        );
        ...
        return (
          <View key={section.id} style={styles.sectionContainer}>
            ...
            {data.references.map((entry) => (
              <View key={entry.id} style={styles.referenceBlock}>
                <Text style={styles.entryTitle}>{entry.name}</Text>
          ...
          <View key={section.id} style={styles.sectionContainer}>
            ...
            {data.courses.map((entry) => (
              <View key={entry.id} style={styles.entryBlock}>
                <View style={styles.entryRow}>
                  <Text style={styles.entryTitle}>{entry.name}</Text>
                  <Text style={styles.entryDate}>{entry.completionDate}</Text>
                </View>
                <Text style={styles.entrySubtitle}>{entry.institution}</Text>
                {entry.description ? <Text style={styles.description}>{entry.description}</Text> : null}
              </View>
