// =============================================================================
// Modern Sidebar - PDF Template (@react-pdf/renderer)
// =============================================================================
      ...
      case 'skills':
        ...
        return (
          <View key={section.id} style={styles.sidebarSection}>
            ...
            <SkillsBlockPdf skills={data.skills} layout={data.skillsLayout} mode={data.skillsMode} fontSize={font.sizes.small} fontFamily={bodyFont} textColor={'rgba(255,255,255,0.75)'} separator=", " categoryWeight={700} categoryColor={'rgba(255,255,255,0.9)'} categoryFontFamily={bodyFont} />
          </View>
        );
...
export default ModernSidebarPdf;
