// =============================================================================
// Clinical Professional - PDF Template (@react-pdf/renderer)
// =============================================================================
...
const ClinicalProfessionalPdf: React.FC<TemplateProps> = ({ resume }) => {
  ...
  const renderBullets = (highlights: string[]) =>
    highlights.map((item, i) => (<Text key={i} style={styles.bulletItem}>{'\u2022'} {item}</Text>));
...
export default ClinicalProfessionalPdf;
