// =============================================================================
// Modern Clean - PDF Template (@react-pdf/renderer)
// =============================================================================
// Clean modern design with accent color top bar, sans-serif fonts.
...
const ModernCleanPdf: React.FC<TemplateProps> = ({ resume }) => {
  ...
  // Build contact items for block layout
  const contactItems = [
    data.contact.email,
    data.contact.phone,
  ...
  const renderSection = (section: SectionConfig) => {
    switch (section.type) {
      case 'contact':
        return (
          <View key={section.id} style={styles.headerContainer}>
            <View>
            ...
            <View>
              {contactItems.map((item, i) => (
                <Text key={i} style={styles.contactBlock}>{item}</Text>
              ))}
            </View>
          </View>
        );
      ...
      case 'skills':
        ...
        return (
          <View key={section.id} style={styles.sectionContainer}>
            <Text style={styles.sectionTitle}>{section.title}</Text>
            <SkillsBlockPdf skills={data.skills} layout={data.skillsLayout} mode={data.skillsMode} fontSize={font.sizes.normal} fontFamily={bodyFont} textColor={colors.text} categoryColor={accentColor} categoryFontFamily={bodyFont} />
          </View>
        );
